...
public class RefundPointsCommandHandler : IRequestHandler<RefundPointsCommand, Result<bool>>
{
    private readonly IShopDbContext _db;
    private readonly IUnitOfWork _unitOfWork;

    public RefundPointsCommandHandler(IShopDbContext db, IUnitOfWork unitOfWork)
    {
        _db = db;
        _unitOfWork = unitOfWork;
    }

    public async Task<Result<bool>> Handle(RefundPointsCommand request, CancellationToken cancellationToken)
    {
